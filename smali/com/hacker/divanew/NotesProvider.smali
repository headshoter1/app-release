.class public Lcom/hacker/divanew/NotesProvider;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/hacker/divanew/NotesProvider$DBHelper;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/hacker/divanew/NotesProvider;->CONTENT_URI:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/hacker/divanew/NotesProvider;->urimatcher:Landroid/content/UriMatcher;
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 110
    sget-object v0, Lcom/hacker/divanew/NotesProvider;->urimatcher:Landroid/content/UriMatcher;
    ...
    .line 118
    iget-object v1, p0, Lcom/hacker/divanew/NotesProvider;->mDB:Landroid/database/sqlite/SQLiteDatabase;
    ...
    const-string v0, "Divanotes(delete): Unsupported URI "
    ...
    .line 113
    :cond_2
    iget-object v0, p0, Lcom/hacker/divanew/NotesProvider;->mDB:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 125
    :goto_1
    invoke-virtual {p0}, Lcom/hacker/divanew/NotesProvider;->getContext()Landroid/content/Context;
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    const-string p1, "vnd.android.cursor.item/vnd.jakhar.notes"
    ...
    :cond_1
    const-string p1, "vnd.android.cursor.dir/vnd.jakhar.notes"
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 148
    sget-object p1, Lcom/hacker/divanew/NotesProvider;->CONTENT_URI:Landroid/net/Uri;
    ...
    const-string v1, "Divanotes: Fail to add a new record into "
...
.method public onCreate()Z
    ...
    .line 157
    new-instance v0, Lcom/hacker/divanew/NotesProvider$DBHelper;

    invoke-virtual {p0}, Lcom/hacker/divanew/NotesProvider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/hacker/divanew/NotesProvider$DBHelper;-><init>(Landroid/content/Context;)V

    .line 158
    invoke-virtual {v0}, Lcom/hacker/divanew/NotesProvider$DBHelper;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v0

    iput-object v0, p0, Lcom/hacker/divanew/NotesProvider;->mDB:Landroid/database/sqlite/SQLiteDatabase;
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 175
    sget-object v1, Lcom/hacker/divanew/NotesProvider;->urimatcher:Landroid/content/UriMatcher;
    ...
    const-string p4, "Divanotes(query): Unknown URI "
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string p4, "Divanotes(update): Unsupported URI "
